...
std::experimental::optional<std::set<mempath>> mempath::separate_propagate(
  ...
  std::experimental::optional<set<mempath>> analysis::mempath::propagate(
    std::function<void(size_t)> imm_ptr_cb, summary_memory_state * from, summary_memory_state * to)
    const {
