    ...
    for(auto edge_it = edges.begin(); edge_it != edges.end(); edge_it++) {
      ...
      ev._([&](const stmt_edge *edge) {
        ...
        v._([&](assign *a) {
          ...
          add_update(node_id, edge_dst_node, new stmt_edge(&s));
        });
        v._([&](load *l) {
        ...
        v._default([&](statement *s) {
          ...
          add_update(node_id, edge_dst_node, new stmt_edge(stmt_new));
          delete stmt_new;
        });
      ...
      ev._([&](const cond_edge *ce) {
        ...
        add_update(node_id, edge_dst_node, new cond_edge(sexpr_new, ce->is_positive()));
        delete sexpr_new;
      });
      ev._([&](const phi_edge *edge) {
        ...
        add_update(node_id, edge_dst_node, new phi_edge(assignments_new));
      });
