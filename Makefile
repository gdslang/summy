...
CFLAGS=-c -O2 -ggdb3 -MMD -std=gnu99 -Wall -Wfatal-errors -DRELAXEDFATAL $(INCDS)
CPPFLAGS=-c -O2 -ggdb3 -MMD -std=c++14 -Wall -Wno-overloaded-virtual -Wno-deprecated $(INCDS)
