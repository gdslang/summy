...
std::string c_compile(std::string program, unsigned int opt) {
  ...
  scope_exit exit([&]() {
    ...
    stringstream ss;
    ss << "clang-3.6 -mcmodel=large -O" << opt << " -std=c11 -fno-inline -fno-optimize-sibling-calls -w program.c -o program.elf";
...
std::string cpp_compile(std::string program, unsigned int opt) {
  ...
  scope_exit exit([&]() {
    ...
    stringstream ss;
    ss << "clang++-3.6 -O" << opt << " -fno-inline -fno-optimize-sibling-calls program.cpp -o program.elf";
