...
TEST_F(vsd_state_test, AssumptionLE1) {
  autogc gc;
  nab n(gc);
...
TEST_F(vsd_state_test, AssumptionLE2) {
  autogc gc;
  nab n(gc);
...
TEST_F(vsd_state_test, AssumptionNEQ1) {
  autogc gc;
  nab n(gc);
...
TEST_F(vsd_state_test, AssumptionNEQ2) {
  autogc gc;
  nab n(gc);
...
TEST_F(vsd_state_test, AssumptionGE) {
  autogc gc;
  nab n(gc);
